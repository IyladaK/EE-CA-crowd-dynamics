...
plot_people_according_to_initial_door_distance(1, people, dom,
                                               ...
                                               filename=prefix + '/cellular_automata_' + str(seed) + '.png')
...
while np.sum(people) > 0:
    ...
    if cc >= drawper:
        ...
        plot_people_according_to_initial_door_distance(1, people, dom,
                                                       results, savefig=False,
                                                       filename=prefix + '/cellular_automata_' + str(iter).zfill(
                                                           6) + '.png')
        cc = 0
...
plot_people_paths(2, dt, dom.pixel_size, people, dom, results,
                  savefig=True, filename=prefix + '/cellular_automata_paths' + str(seed) + '.png')
